...
public interface StockSystemService {
 ...
 @Path("/{pointOfSaleId}/products/{productId}")
    void addToStock(@PathParam("productId") long productId,
                   @PathParam("pointOfSaleId") long pointOfSaleId,
 ...
 @PATCH
 @Path("/{pointOfSaleId}/products/{productId}")
    void removeFromStock(@PathParam("productId") long productId,
                        @PathParam("pointOfSaleId") long pointOfSaleId,
                        @QueryParam("units") int units);
 ...
 @GET
 @Path("/{pointOfSaleId}/products/{productId}")
    int getUnitsOnStock(@PathParam("productId") long productId,
                       @PathParam("pointOfSaleId") long pointOfSaleId);
